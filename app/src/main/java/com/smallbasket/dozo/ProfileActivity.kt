...
import com.smallbasket.dozo.databinding.ActivityProfileBinding
...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun updateUserProfile(name: String, phone: String) {
        ...
        lifecycleScope.launch {
            try {
                Toast.makeText(this@ProfileActivity, getString(R.string.profile_updating), Toast.LENGTH_SHORT).show()
                ...
                Toast.makeText(
                    this@ProfileActivity,
                    com.smallbasket.dozo.utils.ErrorUtils.getFriendlyMessage(this@ProfileActivity, e),
                    Toast.LENGTH_LONG
                ).show()
            }
        }
