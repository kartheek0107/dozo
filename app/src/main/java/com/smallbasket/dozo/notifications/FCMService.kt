...
import com.smallbasket.dozo.Homepage
import com.smallbasket.dozo.RequestDetailActivity
import com.smallbasket.dozo.MyLogsActivity
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        com.smallbasket.dozo.notifications.NotificationManager.saveFCMToken(this, token)
        com.smallbasket.dozo.notifications.NotificationManager.initialize(this)
    }
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        com.smallbasket.dozo.notifications.NotificationManager.saveNotification(this, notificationData)
