package com.smallbasket.dozo.models

import com.google.gson.annotations.SerializedName
import com.smallbasket.dozo.models.DeviceInfo
import com.smallbasket.dozo.models.ConnectivityUpdateRequest
...
data class RewardEstimateResponse(
    @SerializedName("distance_km") val distanceKm: Double,
    @SerializedName("base_fare") val baseFare: Double,
    @SerializedName("item_component") val itemComponent: Double,
    @SerializedName("subtotal") val subtotal: Double,
    @SerializedName("cap_applied") val capApplied: Boolean,
    @SerializedName("reward_before_priority") val rewardBeforePriority: Double,
    @SerializedName("priority_multiplier") val priorityMultiplier: Double,
    @SerializedName("final_reward") val finalReward: Double,
