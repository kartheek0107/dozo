...
import com.smallbasket.dozo.models.*
...
interface ApiService {
    ...
    @GET("request/estimate-reward")
    suspend fun estimateReward(
        @Query("item_price") itemPrice: Double,
        @Query("pickup_area") pickupArea: String,
        @Query("drop_area") dropArea: String,
