// File: app/src/main/java/com/smallbasket/dozo/location/LocationTrackingCoordinator.kt
...
class LocationTrackingCoordinator private constructor(private val context: Context) {
    ...
    /**
     * Force update location and sync with backend
     */
    suspend fun forceUpdateLocation(): LocationData? {
        Log.d(TAG, "Forcing location update")
        return foregroundLocationManager.getInstantLocation()
    }
