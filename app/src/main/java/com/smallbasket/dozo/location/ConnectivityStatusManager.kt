// File: app/src/main/java/com/smallbasket/dozo/location/ConnectivityStatusManager.kt
    ...
    private val connectivityCallback = object : ConnectivityManager.NetworkCallback() {
        override fun onAvailable(network: Network) {
            ...
            scope.launch {
                ...
                val intent = Intent("com.smallbasket.dozo.CONNECTIVITY_CHANGED")
                intent.putExtra("connected", true)
                intent.setPackage(context.packageName) // ✅ Security: Explicit intent
