...
class RequestDetailActivity : AppCompatActivity() {
    ...
    private fun initializeViews(
        ...
        if (!deadline.isNullOrEmpty()) {
            val timeRemaining = com.smallbasket.dozo.utils.TimeUtils.getTimeRemaining(deadline)
            ...
            btnAcceptRequestInner.setOnClickListener {
                ...
                lifecycleScope.launch {
                    try {
                        ...
                        result.onFailure { error ->
                            Toast.makeText(this@RequestDetailActivity, com.smallbasket.dozo.utils.ErrorUtils.getFriendlyMessage(this@RequestDetailActivity, error), Toast.LENGTH_SHORT).show()
                        ...
                        Toast.makeText(this@RequestDetailActivity, com.smallbasket.dozo.utils.ErrorUtils.getFriendlyMessage(this@RequestDetailActivity, e), Toast.LENGTH_SHORT).show()
