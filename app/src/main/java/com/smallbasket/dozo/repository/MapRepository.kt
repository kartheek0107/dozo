// File: app/src/main/java/com/smallbasket/dozo/repository/MapRepository.kt
package com.smallbasket.dozo.repository

import android.util.Log
import com.smallbasket.dozo.api.RetrofitClient
import com.smallbasket.dozo.models.NearbyUsersRequest
import com.smallbasket.dozo.models.NearbyUsersResponse
import com.smallbasket.dozo.models.MyGPSLocationResponse
import com.smallbasket.dozo.models.UsersInAreaResponse
import com.smallbasket.dozo.models.ReachableCountResponse
import com.smallbasket.dozo.models.ReachableByAreaResponse
    ...
    suspend fun getReachableUsersByArea(
        ...
        return try {
            ...
            if (response.isSuccessful && response.body() != null) {
                ...
                // ✅ R8 FIX: The field might be mapped as a LinkedTreeMap or Class by R8
                // We ensure it's treated as a Map safely.
                val areaCounts = body.areaCounts as? Map<String, Int> ?: emptyMap()
