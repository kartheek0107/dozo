// File: app/src/main/java/com/example/smallbasket/location/PermissionCoordinator.kt
...
class PermissionCoordinator private constructor(
    ...
    companion object {
        ...
        private const val REQUEST_COOLDOWN_MS = 3000L

        // Maximum time a request can be "in progress" before auto-reset
        private const val MAX_REQUEST_DURATION_MS = 30000L
    ...
    fun initialize(activity: FragmentActivity) {
        Log.d(TAG, "Initializing PermissionCoordinator")
        currentActivity = activity

        // Create permission manager if not exists
